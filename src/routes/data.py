...
async def process(request: Request, project_id: str, process_request: ProcessRequest):
    ...
    if process_request.file_id:
        ...
        if asset_record is None:
            return JSONResponse(
                ...
                content={"message": f"File with id {process_request.file_id} not found in the project"})
    ...
    for asset_id , file_id in project_files_ids.items():
        ...
        # Check if file content was successfully loaded
    ...
    return JSONResponse({
        ...
        "Number of files processed": no_of_files
    })
